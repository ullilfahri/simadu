...
?>
                            ...
                            <form method="post" action="simpan_final_beli.php" autocomplete="off" name="formGaji">
                            ...
                            <label for="email_address">Biaya Lainnya, Klik Tombol Jika Ada Biaya-Biaya &nbsp;&nbsp;&nbsp;
                            	<button class="btn btn-success btn-xs add-more" type="button"><i class="glyphicon glyphicon-plus"></i></button>
                            </label>
                            
                                <div class="form-group control-group after-add-more">
                                  <div class="col-md-6">
                                    <div class="form-line">
                    					<input type="text" name="jenis_biaya[]" class="form-control" placeholder="Masukan Jenis Biaya">
                                    </div>
                                 </div>
                                  <div class="col-md-6">
                                    <div class="form-line">
                    					<input type="text" name="jumlah_biaya[]"  id="biaya" class="form-control uang" value="0" placeholder="Masukan Jumlah Biaya (Rp)" >
                                    </div>
                                 </div>
                               </div> 
       						...
       						<div class="copy hide">
       							<div class="control-group input-group" style="margin-top:10px">
       								...
       								<div class="col-md-6">
       									<div class="form-line">
       										<input type="text" name="jumlah_biaya[]" id="biaya_tambah[]" class="form-control uang" placeholder="Masukan Jumlah Biaya (Rp)">
       									</div>    
       								</div>
            
       								<div class="input-group-btn"> 
       								<button class="btn btn-danger btn-xs remove" type="button"><i class="glyphicon glyphicon-remove"></i></button>
       								</div>
       							</div>
       						</div>                             
                            <br>  
                            
                            <label for="email_address">Potongan Global Sesuai Nota (Rp)</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="text" id="diskon" name="potongan" class="form-control uang" onFocus="startCalc();" onBlur="stopCalc();" data-rule="quantity" required />
                                    </div>
                                </div>
                            ...
                            <label for="email_address">Total Invoice</label>
                                ...
                                <div class="demo-checkbox">
                                        ...
                                        <label for="metode_bayar">Pembayaran Mundur</label>
                                </div>
                            
                            <div id="input_hutang" style="display:none">
                            <label for="jatuh_tempo">Tanggal Jatuh Tempo</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="date" id="jatuh_tempo" name="jatuh_tempo" class="form-control date"/>
                                    </div>
                                </div>
                            ...
                            <label for="uang_muka">Uang Muka</label>
                                <div class="form-group">
                                    <div class="form-line">
                                        <input type="txt" id="uang_muka" name="uang_muka" class="form-control uang" onFocus="startCalc();" onBlur="stopCalc();" />
                                    </div>
                                </div>
...
<script>
    ...
    function calc(){
	    harga = hilang_titik(document.formGaji.harga.value);
	    potongan = hilang_titik(document.formGaji.potongan.value);
	    uang_muka = hilang_titik(document.formGaji.uang_muka.value);
	    total = hilang_titik(document.formGaji.total.value);
		...
		//awalnya=parseInt(hilang_titik(harga) - parseInt(hilang_titik(potongan);
		
	    total_awal = harga - potongan;
	    hutang = total_awal - uang_muka;
		document.formGaji.total.value = tandaPemisahTitik(total_awal);
		document.formGaji.jumlah_hutang.value = tandaPemisahTitik(hutang);
...
$total=$conn->query("SELECT SUM(sub_total) FROM `pembelian_sementara` WHERE id_pembelian = '".$pecah[0]."' AND distributor = '".$pecah[1]."' ")->fetch_array();
?>
