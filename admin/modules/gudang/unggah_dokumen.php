                            ...
                            <form name="form_faktur">
                                ...
                                <b>No Faktur</b>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="no_faktur" class="form-control" placeholder="Masukan No Faktur">
                                        </div>
                                    </div>
                                </div>
...
$(".data_paginasi").load("data_paginasi.php?uri=cari_tanggal&date_1=<?=$_GET['date_1']?>&date_2=<?=$_GET['date_2']?>");
<?php } else if ($_GET['menu']=='sukses_upload') {?>
$(".data_paginasi").load("data_paginasi.php?uri=sukses_upload&no_faktur=<?=$_GET['no_faktur']?>");
<?php } else {?>
$(".data_paginasi").load("data_paginasi.php?uri=hari_ini");
<?php }?>
...
if (no_faktur =='') {
	...
	$('.data_paginasi').load('data_paginasi.php?uri=sukses_upload&no_faktur='+no_faktur);
	}
}
...
if (awal =='' || akhir == '') {
	...
	$('.data_paginasi').load('data_paginasi.php?uri=cari_tanggal&date_1='+awal+'&date_2='+akhir);
	}
}
</script>
