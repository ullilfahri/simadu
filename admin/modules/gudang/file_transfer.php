            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                PENCARIAN DATA TRANSFER BERDASARKAN NOMOR SURAT TRANSFER
                            </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                            <form name="form_faktur">
                                <div class="col-sm-12">
                                <b>No Surat Transfer</b>
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" name="no_faktur" class="form-control" placeholder="Masukan No Transfer">
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                                PENCARIAN DATA TRANSFER BERDASARKAN TANGGAL
                            </h2>
                        </div>
                        <div class="body">
                            <div class="row clearfix">
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel">RINCIAN DATA TRANSFER BARANG</h4>
                        </div>
