...
?>
    ...
    <section class="content">
        <div class="container-fluid">
                            ...
                            <div class="tab-content">
                                ...
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
									...
									?>
                                        <tr>
                                            <td><?=$nl++?></td>
                                            <td><a href="#" class="live_edit" data-name="nama" data-type="text" data-pk="<?=$l['id_lokasi']?>" data-title="Nama Lokasi"><?=$l['nama']?></a></td>
                                            <td><a href="#" class="live_edit" data-name="alamat" data-type="text" data-pk="<?=$l['id_lokasi']?>" data-title="Nama Lokasi"><?=$l['alamat']?></a></td>
                                            <td><a href="#" class="aktif" data-pk="<?=$l['id_lokasi']?>" data-name="non_aktif" data-type="select" data-value="<?=$l['non_aktif']?>"></a></td>
                                            <td>
            ...
            <!-- Inline Layout -->
                            <form method="post" action="form_crud_lokasi.php">
            ...
            <!-- #END# Inline Layout -->
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="tambah_lokasi">
                                    ...
                                    <div id="map" style="width:900px;height: 300px;"></div>
                                    	<form   method="POST" id="form1" action="form_crud_lokasi.php" class='form-horizontal'>
...
<script type="text/javascript">
    $('.live_edit').editable({
           url: '../global/update.php?live_edit&tabel=lokasi&jenis_id=id_lokasi',
           type: 'text',
           pk: 1,
           name: 'name',
           title: 'Enter name'
