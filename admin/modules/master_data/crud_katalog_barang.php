...
$masuk=$conn->query(" INSERT INTO `kode_barang`(`kode_barang`, `distributor`, `jenis_barang`, `merek_barang`, `nama_barang`) VALUES('$kode_barang', '$distributor', '$jenis_barang', '$merek_barang', '$nama_barang') ");
