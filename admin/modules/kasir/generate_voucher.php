                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="mainTable">
									...
									?>
                                        <tr>
                                            ...
                                            <td><?=$kasiry[0]?></td>
                                            <td><?=$pelanggan[0]?></td>
                                            <td><button type="button" class="btn btn-danger btn-sm" onClick="confirm_modal('../hutang_piutang/detail_piutang.php?hapus_voucher&&modal_id=<?=$y['id']; ?>');">Hapus</button></td>
                                        </tr>
                                    <?php endwhile;?>    
                                    </tbody>
                                </table>
                                ...
                                <table class="table table-bordered table-striped table-hover dataTable js-exportable" id="mainTable">
									...
									?>
                                        <tr>
                                            ...
                                            <td><?=$tgl?></td>
                                            <td><button type="button" class="btn btn-danger btn-sm" onClick="confirm_modal('../hutang_piutang/detail_piutang.php?hapus_voucher&&modal_id=<?=$x['id']; ?>');">Hapus</button></td>
                                        </tr>
                                    <?php endwhile;?>    
                                    </tbody>
                                </table>
...
function showPromptMessage() {
    swal({
        ...
        text: "Jumlah Potongan <br> Entry Ribuan dapat menggunakan Separator '.' atau ','",
        type: "input",
        ...
        if (!/^[0-9.]+$/.test(inputValue) || inputValue === "") {
            swal.showInputError("Hanya numeric yang diijinkan, misal 1000 <br>atau menggunakan Separator misal 1.000"); return false
        }
    swal({
        title: "Anda Yakin?",
		...
		function () {
    	window.location.href = '../hutang_piutang/detail_piutang.php?kode_voucher=<?=$generate?>&distributor=<?=$_SESSION['distributor']?>&jumlah_potongan=' + inputValue;
		});
        } else {
