                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <input type="hidden" name="distributor" id="distributor">
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-5 form-control-label">
                                        <label>Sisa Stok Gudang</label><br>
                                        <a href="cekstok.php"  target="_blank" >Cek Sisa Stok Manual</a>
                                    </div>
                                    <div class="col-lg-8 col-md-8 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" id="stok_gudang" name="stok_gudang"  class="form-control" value="0">
                                            </div>
                                        </div>
                                    </div>
                                </div>
